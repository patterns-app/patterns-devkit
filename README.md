...
|-----------------------------------------------------------------------------------------------------------|--------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|---|
| inferred has subset of nominal fields                                                                     | realized is always equivalent to inferred  | realized schema will be the inferred schema, but will borrow field definitions from nominal where possible.                                                  | realized always equivalent to nominal. extra fields will be discarded  |   |
| inferred is missing nullable fields from nominal                                                          | realized is always equivalent to inferred  | realized schema will be the inferred schema, but will borrow field definitions from nominal where possible, filling missing columns with NULL                | exception will be raised (OR same as soft?)                            |   |
