...
from basis.core.typing.inference import conform_records_list_to_otype
...
class FileToMemoryConverter(Converter):
    ...
    def _convert(
        ...
        output_records: Any
        if output_sdb.data_format == DataFormat.RECORDS_LIST:
            if input_sdb.data_format == DataFormat.DELIMITED_FILE:
            ...
            elif input_sdb.data_format == DataFormat.JSON_LIST_FILE:
                with input_api.open(input_sdb) as f:
                    output_records = [
