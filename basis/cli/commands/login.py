...
from basis.cli.services.auth import login, logout
from basis.cli.services.list import list_organizations
...
class LoginCommand(BasisCommandBase, Command):
    ...
    def handle(self):
        ...
        if len(organizations) == 1:
            org = organizations[0]
            org_name = org["name"]
            update_local_basis_config(organization_name=org_name)
        else:
