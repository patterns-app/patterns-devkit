...
# from dags.core.runnable import PipeContext, ExecutionContext
# from dags.core.typing.object_type import ObjectTypeLike
# from dags.utils.common import dataclass_kwargs, printd
...
# #             dc_args = dataclass_kwargs(self.config_class, args)
# #             cfg = self.config_class(**dc_args)
# #         else:
# #             cfg = args
