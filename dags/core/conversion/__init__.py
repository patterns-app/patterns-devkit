...
from dags.core.conversion.converter import (
    ConversionPath,
    Converter,
    ConverterLookup,
    StorageFormat,
...
from dags.core.storage.storage import Storage, StorageType
...
def get_converter_lookup() -> ConverterLookup:
    ...
    from dags.core.conversion.memory_to_database import MemoryToDatabaseConverter
    from dags.core.conversion.memory_to_memory import MemoryToMemoryConverter
    from dags.core.conversion.memory_to_file import MemoryToFileConverter
    from dags.core.conversion.file_to_memory import FileToMemoryConverter
