...
# from dags.core.external import ExternalProvider, ExternalResource
# from dags.core.node import Direction
# from dags.core.module import DagsModule
# from dags.core.typing.object_type import ObjectType, ObjectTypeUri
#
#
#
#
...
#         self, otype: ObjectType, m: DagsModule
...
# class PipeIndexer:
#     def get_relations(
#         self, df: PipeDefinition, m: DagsModule
...
#     def get_relations(
#         self, sr: ExternalResource, m: DagsModule
#     ) -> List[ObjectTypeRelation]:
#         from dags.core.pipe import Direction
#
#         env = Environment(create_metadata_storage=False)
#         env.add_module(m)
#
...
#
#     def get_indexable_components(
#         self, s: ExternalProvider, m: DagsModule
#     ) -> Iterable[IndexableComponent]:
#         yield IndexableComponent(
#             key=s.key,
#             module=m.key,
