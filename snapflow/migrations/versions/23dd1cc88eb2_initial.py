...
def upgrade():
    ...
    op.create_table('_snapflow_snap_log',
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('data_format', snapflow.utils.registry.ClassBasedEnumSqlalchemyType(length=128), nullable=False),
    ...
    sa.ForeignKeyConstraint(['data_block_id'], ['_snapflow_data_block_metadata.id'], ),
    sa.ForeignKeyConstraint(['snap_log_id'], ['_snapflow_snap_log.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
